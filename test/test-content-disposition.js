// Copy and paste this script to the console of the background page to run tests.
// If any test fails, an assertion error is printed.
...
var BS = '\\';
var DQUOTE = '"'; 
console.log('Running tests from Firefox');
